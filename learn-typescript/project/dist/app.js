...
// Element / HTMLElement / (HTMLSpanElement / HTMLParagraphElement / HTMLUListElement)
// DOM
...
// fetchCovidSummary().then((response) => { response. });
var CovidStatus;
...
function setDeathsList(data) {
    const sorted = data.sort((a, b) => getUnixTimestamp(new Date(b.Date)) - getUnixTimestamp(new Date(a.Date)));
